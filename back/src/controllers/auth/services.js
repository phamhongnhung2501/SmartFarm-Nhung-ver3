...
async function register(req, res){
    try {
        ...
        console.log(otp.generateOTP(info.phone_number));
...
async function verifyOtp(req, res){
    try{
        ...
        if(!otp.verifyOTP(req.body.code, user.phone_number)) return response.badData(res, "OTP Code is wrong or outdated!!!");
...
async function refreshOTP(req, res){
    try {
        ...
        let OTP = otp.generateOTP(user.phone_number);
